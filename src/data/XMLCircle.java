...
public class XMLCircle {
    ...
    public void insertCircle(Circle circle) throws IOException{
    ...
    public ArrayList<Circle> getAllCircle(){
        ...
        int ciclesQuantity = this.root.getContentSize();
        //obtenemos una lista con todos los elementos de root
        List elementList = this.root.getChildren();
        
        //definimos el tamanno del arreglo
        ArrayList<Circle> ciclesArray = new ArrayList<>(ciclesQuantity);
